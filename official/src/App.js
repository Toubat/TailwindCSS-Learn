      ...
      */}
      ...
      <div className="min-h-full">
        <div className="sticky top-0 z-10">
          ...
          <header className="bg-white shadow opacity-90">
        ...
        <main>
          <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            ...
            <div className="px-4 py-6 sm:px-0">
              <div>
                <div className="grid lg:grid-cols-2 bg-gray-50 2xl:grid-cols-5">
                  <div className="px-8 py-12 max-w-md mx-auto sm:max-w-xl lg:px-12 lg:py-24 lg:max-w-full xl:mr-0 2xl:col-span-2">
                    <div className="xl:max-w-xl">
                      ...
                      <img
                        ...
                        src={beach}
                        alt="Women on the beach"
                      />
                      <h1 className="mt-6 text-2xl font-bold text-gray-900 sm:mt-8 sm:text-4xl ls:text-3xl xl:text-4xl">
                        You can work from anywhere.
                        <br className="hidden lg:inline sm:inline" />
                        <span className="text-brand">Take advantage of it.</span>
                      </h1>
                      <p className="mt-6 text-gray-500 sm:mt-4 sm:text-xl">
                        Workaction helps you find work-friendly rentals in beautiful locations so
                        you can focus on what matters: building your dream team. With Workaction,
                        you can work from anywhere.
                      </p>
